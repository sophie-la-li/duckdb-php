<?php
/**
 * Modified from https://github.com/realFlowControl/1brc
 */
...
function createMeasurements($numRecords, $file) {
    $measurementFile = $file;

    if (file_exists($measurementFile)) {
        return;
    }
...
if ($argc !== 3) {
    echo "Usage: create_measurements.php <number of records to create> <file path>\n";
    exit(1);
}
